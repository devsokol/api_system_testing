 ...
 *
 */
class EntrantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'isPassed' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'entrants_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_specialty'], 'references' => ['specialty', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
