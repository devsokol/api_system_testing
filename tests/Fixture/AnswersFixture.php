...
class AnswersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'current_answer' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'answers_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_question'], 'references' => ['questions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
