...
class BundlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'id_answer' => ['type' => 'index', 'columns' => ['id_answer'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'bundles_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_answer'], 'references' => ['answers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
