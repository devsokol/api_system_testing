...
class QuestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'pre_img' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'questions_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_ticket'], 'references' => ['tickets', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'questions_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_type'], 'references' => ['types_questions', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
